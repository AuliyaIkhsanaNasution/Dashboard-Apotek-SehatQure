                ...
                <div class="flex flex-row -mx-3">
                  <div class="flex-none w-2/3 max-w-full px-3">
                    <div>
                      ...
                      <h5 class="mb-3 font-bold dark:text-white text-teal-600">(+Total uang Masuk)</h5>
                      <p class="mb-0 dark:text-white dark:opacity-60">
                        <span class="text-lg font-bold leading-normal text-teal-500">Rp.<?= number_format( $jual['total_jumlah_bayar'], 0, ',', '.' );?></span>
                      </p>
                    </div>
                  </div>
                  <div class="px-3 text-right basis-1/3">
                ...
                <div class="flex flex-row -mx-3">
                  <div class="flex-none w-2/3 max-w-full px-3">
                    <div>
                      ...
                      <h5 class="mb-3 font-bold dark:text-white text-red-600">(-Total uang keluar)</h5>
                      <p class="mb-0 dark:text-white dark:opacity-60">
                        <span class="text-lg font-bold leading-normal text-red-500">Rp.<?= number_format( $beli['total_jumlah_bayar'], 0, ',', '.'); ?></span>
                      </p>
                    </div>
                  </div>
                  <div class="px-3 text-right basis-1/3">
    ...
    <div class="flex flex-wrap mt-6 -mx-3">
      <div class="w-full max-w-full px-3 mt-0 lg:w-7/12 lg:flex-none">
        <div class="border-black/12.5 dark:bg-slate-850 dark:shadow-dark-xl shadow-xl relative z-20 flex min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border">
          ...
          <div class="flex-auto p-4">
            <div>
              <img src="../assets/img/poto14.jpg" alt="Logo" class="m-auto w-100 rounded-xl overflow-hidden">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="w-full max-w-full px-3 lg:w-5/12 lg:flex-none">
        <div slider class="relative w-full h-full overflow-hidden rounded-2xl">
          ...
          <div slide class="absolute w-full h-full transition-all duration-500">
            <img class="object-cover h-full" src="../assets/img/poto12.jpg" alt="carousel image" />
          ...
          <!-- slide 2 -->
          <div slide class="absolute w-full h-full transition-all duration-500">
            <img class="object-cover h-full" src="../assets/img/poto13.jpg" alt="carousel image" />
            <div class="block text-start ml-12 left-0 bottom-0 absolute right-[15%] pt-5 pb-5 text-white">
              <div class="inline-block w-8 h-8 mb-4 text-center text-black bg-white bg-center rounded-lg fill-current stroke-none">
